...
public class Position extends Message {
	...
	private double alternativeLatitude;

	public double getAlternativeLatitude() {
		return alternativeLatitude;
	}

	public void setAlternativeLatitude(double alternativeLatitude) {
		this.alternativeLatitude = alternativeLatitude;
	}

	private double alternativeLongitude;

	public double getAlternativeLongitude() {
		return alternativeLongitude;
	}

	public void setAlternativeLongitude(double alternativeLongitude) {
		this.alternativeLongitude = alternativeLongitude;
	}
	...
	public String toString() {
		return "Position [protocol=" + protocol + ", serverTime=" + serverTime + ", deviceTime=" + deviceTime + ", fixTime=" + fixTime + ", outdated=" + outdated + ", valid="
				+ valid + ", latitude=" + latitude + ", longitude=" + longitude + ", alternativeLatitude=" + alternativeLatitude + ", alternativeLongitude=" + alternativeLongitude
				+ ", altitude=" + altitude + ", speed=" + speed + ", course=" + course + ", address=" + address + "]";
	}
